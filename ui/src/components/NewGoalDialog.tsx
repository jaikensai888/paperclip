...
export function NewGoalDialog() {
  ...
  const levelLabels: Record<string, string> = {
    company: t('levels.company'),
    team: t('levels.team'),
    agent: t('levels.agent'),
    task: t('levels.task'),
  };
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t('dialogs.newGoal.titleSub') : t('dialogs.newGoal.title')}</span>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <input
            ...
            placeholder={t('dialogs.newGoal.titlePlaceholder')}
            value={title}
        ...
        <div className="px-4 pb-2">
          <MarkdownEditor
            ...
            placeholder={t('dialogs.newGoal.descriptionPlaceholder')}
            bordered={false}
          ...
          <Popover open={parentOpen} onOpenChange={setParentOpen}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                ...
                {currentParent ? currentParent.title : t('dialogs.newGoal.parentGoal')}
              </button>
            </PopoverTrigger>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t('dialogs.newGoal.creating') : newGoalDefaults.parentId ? t('dialogs.newGoal.createSub') : t('dialogs.newGoal.create')}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
