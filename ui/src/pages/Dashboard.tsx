        ...
        <>
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {data.agents.running} {t('common:units.running')}{", "}
                  {data.agents.paused} {t('common:units.paused')}{", "}
                  {data.agents.error} {t('common:units.errors')}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.tasks.open} {t('common:units.open')}{", "}
                  {data.tasks.blocked} {t('common:units.blocked')}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? t('dashboard.ofBudget', { percent: data.costs.monthUtilizationPercent, budget: formatCents(data.costs.monthBudgetCents) })
